...
export const twilioMediaUpload = async (binStr, imageType) => {
  ...
  // const binArr2 = await blobUtil.blobToArrayBuffer(fileBlob);
  // const binStr = await blobUtil.blobToBinaryString(fileBlob);
  // console.log('binArr2', binArr2);
