...
const herokuBaseURL="http://localhost:5000/";
...
export const twilioMediaUpload = async (data, imageType) => {
  ...
  // const res = await axios.post(`${herokuBaseURL}messages/media`, data, {});
