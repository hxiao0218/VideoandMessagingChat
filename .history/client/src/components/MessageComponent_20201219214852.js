        ...
        const imageComponent = (
          <>
            ...
            <a
              ...
              href={msg.mediaURL}
            >
              <img src={cors_api_url+msg.mediaURL} alt={msg.content_type} style={imgStyle} />
              <b style={readStyle}>
                {msg.read ? '     Read' : '     Unread'}
              </b>
            </a>
          ...
          <>
            ...
            >
              <video controls style={imgStyle}>
                <source src={cors_api_url+msg.mediaURL} type={msg.content_type} />
  ...
  useInterval(() => {
    const fetchMessages = async () => {
      ...
      if (!conversationId) { // create conversation + persist sid
        ...
        console.log('[new conversation id]', new_sid);
        setConversationId(new_sid);
      }
      let mediaResp = await getMessagesByConversation(new_sid || conversationId, userId, true);
