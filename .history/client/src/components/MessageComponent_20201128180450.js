...
function MessageChat({ user, contactList }) {
  ...
  const openMenu = () => {
    document.getElementsByClassName('extra-options').style.display = 'block';
  };
      ...
      <main>
        <div className="content">
          ...
          <div className="chat-input" style={inputStyles.chatInput}>
            <Fab color="primary" className="uploadButton" size="small" component="span" aria-label="add" onClick={openMenu} style={inputStyles.buttonStyle}>
              <AddIcon />
            </Fab>
