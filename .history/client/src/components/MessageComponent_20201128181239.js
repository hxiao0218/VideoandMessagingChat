      ...
      <main>
        <div className="content">
          ...
          <div className="chat-input" style={inputStyles.chatInput}>
            <Fab color="primary" className="uploadButton" size="small" component="span" aria-label="add" style={inputStyles.buttonStyle} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
              <AddIcon />
            </Fab>
