    ...
    <div className="curMessage">
      ...
      <main>
        <div className="content">
          ...
          <Divider />
          <br />
          <div className="extra-options" style={inputStyles.extraStyle}>
          ...
          <div className="chat-input" style={inputStyles.chatInput}>
            <label htmlFor="upload-photo">
              ...
              />
              <Fab color="primary" id="uploadButton" size="small" component="span" aria-label="add" style={inputStyles.buttonStyle}>
                <AddIcon />
              </Fab>
            </label>
