...
import {
  ...
  fetchConversation, twilioMediaAuth, twilioMediaUpload,
    ...
    if (!validateFile(curFile)) {
      ...
      try {
        ...
        fileReader.onloadend = (fe) => {
          ...
          console.log('imageBlock arrayBuff', imageBlob.arrayBuffer());
          const imageBin = blobUtil.arrayBufferToBinaryString(arrayBuffer);
          console.log('imageBin', imageBin);
          const res2 = twilioMediaUpload(imageBlob);
        };
